...
namespace CelestialLibrary
{
    public class Planet : CelestialBody
    {
        ...
        public override void Init(string presetName = null)
        {
            base.Init(presetName); // Вызываем Init() базового класса для ввода общих полей

            // Ввод количества спутников с обработкой ошибок
